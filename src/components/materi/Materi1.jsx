...
function Materi1() {
    ...
    return (
        <div className="p-5">
            ...
            {/* Input Pertama */}
            <div className="d-flex justify-content-start align-item-center mb-3"> <div className="col-md-6">
            ...
            <div className="d-flex justify-content-start align-item-center mb-3">
                <div className="col-md-6">
                    ...
                    <input
                        ...
                        className="form-control"
                        id="Input3"
                        placeholder="Kata yang diketikan akan di kirim kesamping" value={message2}
