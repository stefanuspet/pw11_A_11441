...
const Materi2 = () => {
    ...
    const kurangUmur = () => setUmur(umur - 1);
    const tambahUmur = () => setUmur(umur + 1);

    const submitHandler = (e) => {
        e.preventDefault();
        const newItem = { namaMatakuliah, namaDosen };
            ...
            <div className="row align-items-center">
                <div className="col-md-6">
                    <div className="d-flex justify-content-start align-items-center">
                        <div>
                            <h5 className="text-start mb-3 mt-2">Contoh Lain Penggunaan UseState</h5>
                            <h5 className="text-start">
                                Umur Saya: {umur}, dan saya {umur <= 25 ? 'saya masih muda' : 'saya sudah tua'}.
                            </h5>
